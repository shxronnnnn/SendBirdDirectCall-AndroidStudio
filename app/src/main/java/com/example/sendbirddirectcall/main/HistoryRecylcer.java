...
import com.example.sendbirddirectcall.call.CallService;
import com.example.sendbirddirectcall.utils.EndResultUtils;
import com.example.sendbirddirectcall.utils.ImageUtils;
import com.example.sendbirddirectcall.utils.TimeUtils;
...
class HistoryRecyclerViewAdapter extends RecyclerView.Adapter<HistoryRecyclerViewAdapter.HistoryViewHolder> {
    ...
    private final List<DirectCallLog> mDirectCallLogs = new ArrayList<>();
